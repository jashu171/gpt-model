...
if st.button("Submit"):
    ...
    if user_input:
        ...
        # Set up the API key and system prompt
        genai.configure(api_key="AIzaSyCUAqGPCnMq-ftOx8tZpN2ihLilmugyOiU")
        sys_prompt = """You are a simple and beginner-friendly assistant. Your task is to respond to questions in the following way:
...
- **References**: [Links to external resources for further reading.]"""
        ...
        gemini_2_0 = genai.GenerativeModel(model_name="models/gemini-2.0-flash-exp", system_instruction=sys_prompt)

        # Correctly call the generate_content method
        response = gemini_2_0.generate_content(user_input)
